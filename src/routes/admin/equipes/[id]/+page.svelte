...
<div class="max-w-2xl mx-auto">
  <!-- Retour -->
  <a href="/admin/equipes" class="text-sm text-gray-500 hover:text-gray-300 mb-4 inline-block">
    ← Retour aux équipes
  </a>
      ...
      <div class="flex items-start justify-between gap-4">
        <div>
          ...
          <div class="text-xs text-gray-600 mt-2">
            Créée par {data.team.creator_prenom} {data.team.creator_nom}
          </div>
        </div>
  ...
  <div class="bg-gray-900 rounded-xl p-5">
    ...
    {#if data.jeunesNotInTeam.length === 0}
    ...
    {:else}
      <form method="POST" action="?/addMember" use:enhance class="flex gap-2">
        ...
        >
          ...
          {#each data.jeunesNotInTeam as jeune}
