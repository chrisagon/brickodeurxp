...
<div class="max-w-4xl mx-auto">
  <nav class="flex flex-wrap gap-4 mb-6 border-b border-gray-800 pb-3">
    ...
    <a href="/animateur/equipes"     class="text-sm text-gray-400 hover:text-orange-400">Équipes</a>
    <a href="/animateur/projets"     class="text-sm text-gray-400 hover:text-orange-400">Projets</a>
